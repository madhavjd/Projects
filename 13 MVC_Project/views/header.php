...
<link rel="stylesheet" href="<?php echo $this->baseURL ?>css/font-awesome.min.css" type="text/css" media="all" />
<!--// css -->
<!-- font -->
...
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="home"><img src="<?php echo $this->baseURL ?>images/logo2.png" alt=" " /><h1>FASHION<span>CLUB</span></h1></a>
		</div>
	...
	<div class="container">
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav ">
								...
								<ul class="dropdown-menu multi">
									<div class="row">
										...
										<div class="col-sm-4 w3l">
											<a href="women.html"><img src="<?php echo $this->baseURL ?>images/menu1.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-4 w3l">
											<a href="jewellery.html"><img src="<?php echo $this->baseURL ?>images/menu2.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<li><a href="products" class="hyper"><span>Products</span></a></li>
					</ul>
				</div>
			</nav>
		</div>
		...
		<div class="col-md-1 cart-wthree">
			<?php  if (isset($_SESSION['UserData'])){
				$Count = ($CartData['Code'] == 1) ? count($CartData['Data']) : "0" ;
				echo $Count;}?>
			<div class="cart text-center"> 
				<a href="cart"><i class="fa fa-cart-arrow-down" aria-hidden="true"></a></i> 
			</div>
		</div>
		<div class="clearfix"></div>
	</div>
