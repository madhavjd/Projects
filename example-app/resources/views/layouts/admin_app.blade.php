          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="allusers" aria-expanded="false">
                ...
                <span class="hide-menu">Register Employee</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="adminallproducts" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/branch" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
                <span class="hide-menu">All Branch</span>
              </a>
            </li>
            @endif
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/validation" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
